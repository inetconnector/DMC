...
interface InferenceEngine {
    ...
    /**
     * Run a hidden warmup pass to prime the native runtime before the first visible turn.
     */
    suspend fun warmup()
    ...
    /**
     * Returns the logical DMC context capacity exposed by the native engine.
     * The physical KV window can be smaller. Returns 0 when no model is loaded.
     */
    fun contextWindowSize(): Int
    ...
    companion object {
        // Generate until the model emits EOG unless an API caller supplies a limit.
