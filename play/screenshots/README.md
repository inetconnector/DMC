...
the Local AI - DMC Google Play listing. The upload layout follows the `gplay release
...
All six files are direct captures from a Samsung SM-S931B running Local AI - DMC
...
1. Local chat performance: "Lokale Local-AI-DMC-Antwort mit Modellname, Tokenzahl,
   Antwortzeit und Geschwindigkeit."
2. Welcome screen: "Local-AI-DMC-Startansicht mit lokaler Modellauswahl, Spracheingabe
